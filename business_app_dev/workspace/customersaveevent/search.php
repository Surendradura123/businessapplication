...
<?php
                ...
                //search the event by city
    
                if(isset($_GET['search'])){
               
               $event_city= $_GET['user_query'];
               
                $sql = "select * from Event 
                where 
                
                event_city like '%$event_city%'
    ...
    while($row = $result->fetch_assoc()){
        ...
        $id = $row['company_id'];
          ...
          if($row2 = $result2->fetch_assoc()){
                   ...
                   <a href='../customersaveevent/event.php?event_id=$event_id'> <button name='eventAdd' class='btn btn-primary'>View In Details</button> </a>
                                  <br>
                                  <br>  
                         ";
