...
<head>
    ...
    function showDiv() {    //@ref: https://www.w3schools.com/howto/howto_js_toggle_hide_show.asp
                            //If a Company account is logged in, the showPwChange is displayed. If lot logged in or other user-type, the hidePwChange is displayed.
                            
        var show = document.getElementById("showPwChange"); //shows the form for Company to edit their details
        var hide = document.getElementById("hidePwChang"); //hides the form from other user types.
    ...
    <script>
    var check = function() {    //@ref: https://stackoverflow.com/questions/21727317/how-to-check-confirm-password-field-in-form-without-reloading-page 
...
<body onload="showDiv()">
    <?php //echo "Current PW: ".$current_password."<br>Current PW Enc:".$current_password_enc."<br>Enc PW: ".$password_enc ?> <!-- Testing -->
