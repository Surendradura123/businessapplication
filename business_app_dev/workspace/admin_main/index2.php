...
<?php echo $header_text;?>
    ...
    <br>
    <center style="background-color:green;"><h1>Admin Event Page</h1></center>
    <br>
<center>    
        ...
        $comments = $row['comments'];
            ...
            <p>$date </p>
             ";  
                  ...
                  echo "  <form class='delete-form' method='POST' action='admin_main/deleteComment.php?cid=$cid'>
                  ...
                  echo " <form class='edit-form' method='POST' action='../admin_main/editComment.php?event_id=$event_id'>
