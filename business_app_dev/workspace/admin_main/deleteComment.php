...
<?php
  ...
  $cid = $_GET['cid'];
      ...
      echo" <br><br><center><h1 style='background-color:yellow;'>You Comment is successfully deleted!</h1>
      <a href='admin_main/home2.php' class='button'><font size='5' color='#7d24ad'>Event Page</font></a>
      </center>";
      echo "";
