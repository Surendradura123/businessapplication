<?php
    ...
    if (!($user_type_id == '2')){ //If user is not a Company account. redirect to home page.
        header ('Location: /');
    }
...
<!-- Header end -->
  ...
  <!--  </nav>-->
    ...
    <!--If not Log in/ Input box hidden-->
            <div class='col-md-8 order-md-1'>
            <a href='company_add/showEvent.php'><button class='btn btn-primary' >View Event</button></a>
            <br>
            <br>
        <h4 class='mb-3'>Event Add Page</h4>
        
        
        <form action="../company_add/showEvent.php" method="post">
